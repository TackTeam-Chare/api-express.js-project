...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2024 at 11:20 AM
...
(2, 'tackteam_Admin', '$2a$10$toz63FzTuYTtxaldh2fahOBlhenIAn/oGbK/m5Aa1fGWzlJeyEkUm', 'tackteam_Admin');
...
(1, 'ธรรมชาติและสวนสาธารณะ (Nature and Parks)'),
(2, 'วัฒนธรรมและประวัติศาสตร์ (Culture and History)'),
(3, 'การพักผ่อนและบันเทิง (Recreation and Entertainment)'),
(4, 'การท่องเที่ยวชุมชน (Community Tourism)'),
(5, 'สถานที่ท่องเที่ยวทางน้ำ (Water Attractions)'),
(6, 'สถานที่ท่องเที่ยวทางศิลปะและหัตถกรรม (Art and Craft)'),
(7, 'การผจญภัยและกีฬากลางแจ้ง (Adventure and Outdoor Sports)'),
(8, 'ร้านค้าของฝาก (Souvenir Shops)'),
(9, 'ร้านอาหาร (Restaurants)'),
(10, 'ที่พัก (Accommodations)'),
(11, 'สถานที่ท่องเที่ยว (Tourist Attractions)');
...
(1, 'เมืองนครพนม (Mueang Nakhon Phanom)'),
(2, 'โพนสวรรค์ (Phon Sawan)'),
(3, 'ธาตุพนม (That Phanom)'),
(4, 'เรณูนคร (Renu Nakhon)'),
(5, 'นาแก (Na Kae)'),
(6, 'นาทม (Na Thom)'),
(7, 'บ้านแพง (Ban Phaeng)'),
(8, 'วังยาง (Wang Yang)'),
(9, 'ท่าอุเทน (Tha Uthen)'),
(10, 'นาแห้ว (Na Wa)'),
(11, 'นาหว้า (Na Wa)'),
(12, 'ปลาปาก (Pla Pak)'),
(13, 'ศรีสงคราม (Si Songkhram)');
...
(1, 'ฤดูร้อน (Summer)', '2024-02-15', '2024-05-15'),
(2, 'ฤดูฝน (Rainy)', '2024-05-15', '2024-10-15'),
(3, 'ฤดูหนาว (Winter)', '2024-10-15', '2025-02-15'),
(4, 'ประจำปี (Annual)', '2024-01-01', '2024-12-31');
